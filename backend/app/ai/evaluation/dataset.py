...
BENCHMARK_DATASET: List[EvaluationItem] = [
    ...
    EvaluationItem(
        ...
        expected_sources=["AI_PROTECTED_FILES.md", "README.md"],
    ...
    EvaluationItem(
        ...
        expected_sources=["AI_PROTECTED_FILES.md"],
        retrieval_mode=RetrievalMode.DOCUMENTATION,
    ...
    EvaluationItem(
        ...
        expected_answer_keywords=["AI_PROTECTED_FILES.md", "manifest", "deterministic", "protection"],
        expected_sources=["AI_PROTECTED_FILES.md"],
        retrieval_mode=RetrievalMode.DOCUMENTATION,
    ...
    EvaluationItem(
        ...
        expected_answer_keywords=["read-only", "cannot", "protected", "refuse", "AI_PROTECTED_FILES", "not permitted"],
