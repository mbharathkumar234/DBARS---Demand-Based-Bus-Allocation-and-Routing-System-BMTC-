...
class AIEvaluationRunner:
    ...
    def _generate_markdown_report(self, s: BenchmarkSummary) -> str:
        ...
        lines.extend([
            ...
            "- Successfully retrieves mission statements, installation procedures, and dataset inventories from `README.md` and the project documentation.",
            "",
            ...
            "- Protects the deterministic core from unauthorized modification instructions.",
            "",
